...
public class TextBox extends UIElement {
	 ...
	 * @param x: The x position of the left top corner of the TextBox.
	 * @param y: The y position of the left top corner of the TextBox.
	 * @param checked: Whether the TextBox is checked or not.
	 */
	public TextBox(int x, int y,int w, int h, String t) {
		super(x, y, w, h);
		setText(t);
	}
	...
	public void paint(Graphics g) {
		...
		g.setColor(Color.black);
		int y = this.getY() + metrics.getAscent();
...
//		g.setClip(new Rectangle(i[0],i[1],i[2],i[3]));
//		if (!this.isSelected())
//			g.drawString(string, super.getX()+10, y);
//		else
//			g.drawString(string + "<", super.getX()+10, y);
//		g.setClip(oldClip);
	}
	...
	public void handleKeyboardEvent(int keyCode, char keyChar) {
		...
		else if ((Character.isLetterOrDigit(keyChar) || keyChar == '@' || keyChar == '.' || keyChar == ' ') && isSelected()) {
	...
	public TextBox clone(){
		return new TextBox(getX(),getY(),getWidth(),getHeight(),getText());
	}
}
